...
Миграции подымаются автоматически, в случае их отсутствия.

Пример использования: - пондять проект - Регистрируем юзера. - Получаем access токен. - Этот токен вставляем в Хедеры запросов. - осуществляем роут на сервисы news.
